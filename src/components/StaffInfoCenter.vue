            ...
            <div class="form-box percent-70" v-loading="formLoading">
                <el-form ref="form" :model="formData" :rules="rules" label-width="120px" size="small">
                    ...
                    <el-form-item label="员工类型" prop="type">
                        <el-select v-model="formData.type" :disabled="formData.type === 1" placeholder="请选择员工类型">
    ...
    export default {
        ...
        methods: {
            ...
            statusClick(row){
                ...
                this.$confirm('确认要'+statusText+'此员工吗？', '提示', {
                    ...
                    this.axios({
                        method: 'PUT',
                        url: '/enterprises/personal/changeUsing',
                        data: {
                            ids: [row.id],
            ...
            formSubmit(){
                this.$refs['form'].validate( valid => {
                    if(valid){
                        ...
                        let url = this.isAdd?'/enterprises/personal/insert':'/enterprises/personal/update';
                        this.axios({
                            method: method,
                            url: url,
                            data: this.formData
            ...
            initPassword(){
                ...
                this.$confirm('确认要初始化密码吗？', '提示', {
                    ...
                    this.axios({
                        method: 'PUT',
                        url: '/enterprises/user/resetPassword',
                        params: {
                            id: this.currentId
                        }
                    }).then(res => {
            ...
            getDataList(){
                ...
                this.axios({
                    method: 'GET',
                    url: '/enterprises/personal/getList',
                    params: {
