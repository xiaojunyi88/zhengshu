            ...
            <div class="form-box percent-70" v-loading="formLoading">
                <el-form ref="form" :model="formData" :rules="rules" label-width="120px" size="small">
                    <el-form-item label="活动项目" prop="service_item_id">
                        <el-select v-model="formData.service_item_id" placeholder="请选择活动项目"  style="width: 100%">
                            <el-option
        ...
        data(){
            return {
                ...
                formData: {
                    ...
                    plan_begin_time: '',
                    plan_end_time: '',
                    addr: JSON.parse(localStorage.getItem('Auth')).addr,
                    plan_number: '',
                    type: 1,
                    remark: '',
                    initiator: JSON.parse(localStorage.getItem('Auth')).id
                },
                // 验证规则
                rules: {
                    addr: [
        ...
        methods: {
            ...
            getItemList(){
                return this.axios({
                    ...
                    params: {
                        branches_id: this.formData.branches_id
                    }
                })
            },
            ...
            async addActivity(){
                ...
                let itemRes = await this.getItemList();
                this.itemList = itemRes['dataList'];
